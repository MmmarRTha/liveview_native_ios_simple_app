defmodule IosSimpleAppWeb.CoreComponents.SwiftUI do
  @moduledoc """
  ...
  of the `IosSimpleAppWeb.CoreComponents` functions you should expect identical functionality for similarly named
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(IosSimpleAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(IosSimpleAppWeb.Gettext, "errors", msg, opts)
    end
  end
