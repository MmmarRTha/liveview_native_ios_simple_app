defmodule IosSimpleAppNative do
  @moduledoc """
  ...
  import IosSimpleAppWeb, only: [verified_routes: 0]
  ...
  def live_view() do
    quote do
      use LiveViewNative.LiveView,
        ...
        layouts: [
          swiftui: {IosSimpleAppWeb.Layouts.SwiftUI, :app}
        ]
  ...
  defp helpers(format) do
    ...
    core_component_module = Module.concat([IosSimpleAppWeb, CoreComponents, plugin.module_suffix])
